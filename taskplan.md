...
| make a SSNN sound harder | SSNN should sound close, present, and punchy at the default master gain without masking the workstation mix | Default SSNN showed a high wet setting that was not wired to DSP, with conservative per-spike gain and wide placement | Fail | Fail | Neural voices sounded distant or behind the main mix even with visible spike activity | Fail |
