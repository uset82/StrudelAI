    ...
    functionDeclarations: [
        ...
        },
        {
            ...
            parameters: {
                type: SchemaType.OBJECT,
                properties: {
                    trackId: { type: SchemaType.STRING, enum: ['drums', 'bass', 'melody', 'fx'], description: 'The track to update.' },
        ...
        },
        {
            ...
            parameters: {
                type: SchemaType.OBJECT,
                properties: {
                    trackId: { type: SchemaType.STRING, enum: ['drums', 'bass', 'melody', 'fx'] },
...
export async function handleVoiceCommand(text: string, currentState: SonicSessionState) {
    try {
        ...
        let newState = JSON.parse(JSON.stringify(currentState)); // Deep clone
