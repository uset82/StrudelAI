...
const GENRE_PATTERNS: Array<[GenreKey, RegExp]> = [
    ...
    ['rock', /\b(rock|guitar|riff|power\s*chords?|distorted\s*guitar|grunge|hard\s*rock|folk|acoustic|indie|alternative)\b/i],
    ['funk', /\b(funk|funky|groove|disco|nu-?disco)\b/i],
    ['jazz', /\b(jazz|jazzy|swing|blues|bossa(?:\s*nova)?)\b/i],
